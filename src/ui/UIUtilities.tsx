...
type DeviceSizeKey = 'xSmall' | 'small' | 'medium' | 'large' | 'xLarge';
...
export const useColors = (color: ColorKey): string => {
  ...
  // If it's a valid hex, RGB(A), or any normal color string, return it as is
  if (
